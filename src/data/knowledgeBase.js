...
export const PERSONAS = {
    "frontend_developer": {
        ...
        features: { visual: 1, logic: 1, hardware: -1, math: 0, server: -1, security: 0, users: 1, creative: 1 },
    ...
    "backend_developer": {
        ...
        features: { visual: -1, logic: 1, hardware: 0, math: 0, server: 1, security: 1, users: -1, creative: 0 },
    ...
    "mobile_developer": {
        ...
        features: { visual: 1, logic: 1, hardware: 0, math: 0, server: 0, security: 0, users: 1, creative: 1, mobile: 1 },
    ...
    "game_developer": {
        ...
        features: { visual: 1, logic: 1, hardware: 0, math: 1, server: 0, security: 0, users: 1, creative: 1, game: 1 },
    ...
    "data_scientist": {
        ...
        features: { visual: -1, logic: 1, hardware: 0, math: 1, server: 0, security: 0, users: -1, creative: 0, data: 1 },
    ...
    "embedded_engineer": {
        ...
        features: { visual: -1, logic: 1, hardware: 1, math: 1, server: -1, security: 0, users: -1, creative: 0, low_level: 1 },
    ...
    "cyber_security": {
        ...
        features: { visual: -1, logic: 1, hardware: 0, math: 0, server: 1, security: 1, users: -1, creative: 0, hacking: 1 },
    ...
    "devops_engineer": {
        ...
        features: { visual: -1, logic: 1, hardware: 0, math: 0, server: 1, security: 1, users: -1, creative: 0, infra: 1 },
    ...
    "qa_engineer": {
        ...
        features: { visual: 0, logic: 1, hardware: 0, math: 0, server: 0, security: 0, users: 1, creative: -1, detail_oriented: 1 },
    ...
    "blockchain_dev": {
        ...
        features: { visual: -1, logic: 1, hardware: 0, math: 1, server: 1, security: 1, users: -1, creative: 0, crypto: 1 },
